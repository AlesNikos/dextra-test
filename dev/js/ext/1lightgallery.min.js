            ...
            ! function (s, i) {
                ...
                s.prototype.init = function () {
                    ...
                    if (!l.default.hasClass(i.___slide[e], "lg-loaded")) {
                        ...
                        } else m ? (i.___slide[e].insertAdjacentHTML("beforeend", '<div class="lg-video-cont "><span class="lg-close lg-close-custom"></span><div class="lg-video"></div></div>'), l.default.trigger(i.el, "hasVideo", {
                            index: e,
                            src: a,
                            html: c
                        })) : (g = g ? 'alt="' + g + '"' : "", i.___slide[e].insertAdjacentHTML("beforeend", '<div class="lg-img-wrap"><span class="lg-close lg-close-custom"></span><img class="lg-object lg-image" ' + g + ' src="' + a + '" /></div>'));
